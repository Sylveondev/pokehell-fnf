...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Outsmoked",		"Beat the vaporeon week with no Misses.",				'week1_nomiss',			false],
		["Stellar Performance",				"Beat the jolteon week with no Misses.",				'week2_nomiss',			false],
		["Major Malfunction",			"Beat the flareon week with no Misses.",				'week3_nomiss',			false],
		["Scared Silly",					"Beat the umbreon week with no Misses.",				'week4_nomiss',			false],
		["Solid Ice",			"Beat the glaceon week with no Misses.",				'week5_nomiss',			false],
		["Still Alive",					"Beat the sylveon week with no Misses.",				'week6_nomiss',			false],
		["Gears God",		"Beat the espeon week with no Misses.",				'week7_nomiss',			 false],
		["I Suck!",	"Complete a Song with a rating lower than 20%.",	'ur_bad',				false],
		["I'm Amazing!",				"Complete a Song with a rating of 100%.",			'ur_good',				false],
		["Brutal Legend",			"Not unlockable yet.",			'brutal',	true],
		["I'm Screaming the Lyrics!",		"Hold down a note for 20 seconds.",					'oversinging',			false],
...
class AchievementObject extends FlxSpriteGroup {
	...
	public function new(name:String, ?camera:FlxCamera = null)
	{
		...
		achievementName.setFormat(Paths.font("righteous.ttf"), 16, FlxColor.WHITE, LEFT);
		achievementName.scrollFactor.set();

		var achievementText:FlxText = new FlxText(achievementName.x, achievementName.y + 32, 280, Achievements.achievementsStuff[id][1], 16);
		achievementText.setFormat(Paths.font("righteous.ttf"), 16, FlxColor.WHITE, LEFT);
